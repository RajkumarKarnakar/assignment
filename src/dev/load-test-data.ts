...
async function main() {
  ...
  await client.collection("sample").deleteMany({});

  const resp = await client.collection("sample").insertMany([
    {
  ...
  console.info("Inserted data into database:", resp.insertedCount);
